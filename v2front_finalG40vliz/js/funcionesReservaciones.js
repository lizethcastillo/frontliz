...
function getReservaciones(){
    $.ajax({
        url:"http://129.146.16.176:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function postReservaciones(){
    ...
    $.ajax({
        url:"http://129.146.16.176:8080/api/Reservation/save",
        type:"POST",
        datatype:"JSON",
...
function getTool_Reservaciones(){
    $.ajax({
        url:"http://129.146.16.176:8080/api/Tool/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function getClient_Reservaciones(){
    $.ajax({
        url:"http://129.146.16.176:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
           // console.log(respuesta);
